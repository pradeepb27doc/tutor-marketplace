...
import type { BreakFormData, FieldErrors, MutationResult } from "../types";

interface BreakFormProps {
  onSubmit: (data: BreakFormData) => Promise<MutationResult>;
  onCancel: () => void;
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => {
            ...
            handleChange("dayOfWeek", val === "" ? null : val);
          }}
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            handleChange("reason", e.target.value || null)
          }
          className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
        />
      </div>
